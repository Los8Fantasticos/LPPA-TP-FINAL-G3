...
{
    public class ApplicationDbContext : IdentityDbContext<Users,IdentityRole,string,IdentityUserClaim<string>, AppUserRoles,IdentityUserLogin<string>, IdentityRoleClaim<string>, IdentityUserToken<string>>
    {
